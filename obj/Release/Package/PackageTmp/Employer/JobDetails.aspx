<%@ Page Title="" Language="C#" MasterPageFile="~/Employer/Employer.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="JobPortalWebApplication.Employer.JobDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <div class="job-details-container" runat="server" id="JobDetailsContainer" style="font-family:Calibri;background-color:aliceblue">
            ...
            <div class="job-card" style="background-color:aliceblue;padding:20px; margin: 0 auto; width: 80%;">
               ...
               <%-- <div class="actions">
                    <asp:Button ID="ApplyButton" runat="server" Text="" CssClass="btn btn-primary" OnClick="btnApply_Click" />
                </div>--%>
