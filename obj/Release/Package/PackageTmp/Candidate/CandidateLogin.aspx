<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CandidateLogin.aspx.cs" Inherits="JobPortalWebApplication.Candidate.CandidateLogin" %>
  ...
  <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail" ValidationExpression="^[\w\.-]+@[\w\.-]+\.\w+$"
    ...
    CssClass="text-danger" Display="Dynamic" />
                ...
                <div class="row">
                    ...
                    <div class="col-4">
 <asp:Button ID="Button2" runat="server" Text="ForgotPassword??" OnClick="btnResetPwd_Click" CssClass="btn btn-warning" CausesValidation="false" />
