<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin1.Master" AutoEventWireup="true" CodeBehind="AddTrainers.aspx.cs" Inherits="JobPortalWebApplication.Admin.AddTrainers"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:TextBox ID="txtAreaofSpecialization" runat="server" CssClass="form-control" />
 </div>
                <!-- Agreement to Terms -->
