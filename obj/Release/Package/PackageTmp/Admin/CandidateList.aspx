...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        /* Basic styling for the dialog background overlay */
.confirm-dialog {
                                            ...
                                            <div class="col-md-1 action-block d-none d-sm-block">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="">
                                                     ...
                                                     <!-- Trigger link/button -->
<a class="dropdown-item" href="javascript:void(0);" onclick="openConfirmDialog('<%# Eval("CandidateID") %>');">
...
<!-- Confirmation Dialog -->
    ...
    <script type="text/javascript">
        ...
        // Open the dialog and pass the candidate ID
        function openConfirmDialog(candidateID) {
            window.candidateToDelete = candidateID; // Store candidate ID globally
        ...
        function confirmDelete() {
            ...
            window.location.href = 'CandidateList.aspx?deleteID=' + window.candidateToDelete;
            closeConfirmDialog();
        }
