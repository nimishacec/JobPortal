<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerReg.aspx.cs" Inherits="JobPortalWebApplication.Trainer.TrainerReg" %>
...
<div class="p-4 rounded" style="background-color: white; max-width: 500px; width: 100%;">
    ...
    <div class="row mb-3 justify-content-center">
        <div class="col-md-8">
            ...
            <asp:Button ID="Button5" runat="server" Text="Login" CssClass="btn btn-success mx-2" OnClick="TrainerLogin_Click" />
        </div>
    </div>
     ...
     <div class="container mt-4" id="registrationFields" runat="server" visible="false">
      ...
      <div class="row mb-3 justify-content-center">
          <div class="col-md-8">
              ...
              <asp:Button ID="Button2" runat="server" Text="Login" CssClass="btn btn-success mx-2" OnClick="TrainerLogin_Click" />
          </div>
      </div>
  </div>
