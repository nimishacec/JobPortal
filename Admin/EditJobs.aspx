<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin1.Master" AutoEventWireup="true" CodeBehind="EditJobs.aspx.cs" Inherits="JobPortalWebApplication.Admin.EditJobs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function ValidateStartDate(sender, args) {
            ...
            // Get existing start date from a hidden field or server-rendered attribute if needed
            var existingStartDate = new Date(document.getElementById('<%= txtApplicationStartDate.ClientID %>').value);

            if (selectedDate.getTime() !== existingStartDate.getTime() && selectedDate <= today) {
                args.IsValid = false;
            } else {
                args.IsValid = true;
            }
