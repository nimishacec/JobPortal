<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin1.Master" AutoEventWireup="true" CodeBehind="TrainerViewDash.aspx.cs" Inherits="JobPortalWebApplication.Admin.TrainerViewDash" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <style>
        .gridview-background {
    background-color:cornsilk; /* Replace with your desired color code */
}
    </style>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <a href="TrainersList.aspx">Back</a>
 </div>
            <div class="card">
                     <h3 class="text-center mt-3"><strong>Trainer Details</strong></h3> 
                  <div class="row">
                  ...
                  <asp:Image ID="imgCompanyLogo" runat="server" Width="200px" Height="150px" ImageUrl='<%# Eval("CompanyLogoURL") %>' />
                              ...
                              <div class="row ms-4">
                               ...
                               <div class="row ms-4">
                                  ...
                                  <div class="col-md-8">
                                     <asp:Label ID="lblSpecializationValue" runat="server" />
                                  </div>
                              </div>  <hr />
                                <div class="row ms-4">
                                  <div class="col-md-4">
