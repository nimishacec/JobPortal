<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CandidateDashboard.aspx.cs" MasterPageFile="~/Admin/Admin1.Master" Inherits="JobPortalWebApplication.Admin.CandidateDashboard" EnableEventValidation="false" %>
                ...
                <div id="addExperienceForm" style="display: none;">
                    <div class="row">
                        ...
                        <div class="form-group mt-2">
                            <asp:LinkButton ID="btnAddWorkExperience" runat="server" OnClick="btnAddWorkExperience_Click" CssClass="btn btn-outline-primary btn-rounded btn-fw">
     <i class="mdi mdi-content-save-edit"></i>Save</asp:LinkButton>
                            ...
                            --%>
                            <asp:Button ID="btnCancelWorkExperience" runat="server" Text="Cancel" CssClass="btn btn-outline-secondary" OnClick="btnCancelWorkExperience_Click" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <asp:Label ID="Label17" runat="server" Text="Core Skill percentage:" CssClass="form-label"></asp:Label>
                                 <div class="mt-2">
                                <asp:TextBox ID="CoreSkillPercentage" runat="server" CssClass="form-control" Text='<%# Eval("Percentage") %>'></asp:TextBox>
                            </div> </div>
                        </div>
                       <div class="form-group mt-2 d-flex justify-content-end">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <asp:Label ID="Label17" runat="server" Text="Soft Skill percentage:" CssClass="form-label"></asp:Label>
                                 <div class="mt-2">
                                <asp:TextBox ID="SoftSkillPercentage" runat="server" CssClass="form-control" Text='<%# Eval("Percentage") %>'></asp:TextBox>
                            </div>
                                 </div>
                        </div>
                      <div class="form-group mt-2 d-flex justify-content-end">
