<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployerLogin.aspx.cs" Inherits="JobPortalWebApplication.Employer.EmployerLogin" %>
...
CssClass="text-danger" Display="Dynamic" />
            ...
            <div class="row">
                <div class="col text-center">
                    <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" CssClass="btn btn-primary mx-1" />
                    <asp:Button ID="Button2" runat="server" Text="Forgot Password?" OnClick="btnResetPwd_Click" CssClass="btn btn-secondary mx-1"  CausesValidation="false"/>
                    <asp:Button ID="button" Text="Register" runat="server" CssClass="btn btn-success mx-1" Onclick="btnRegister_Click" CausesValidation="false"/>
                </div>
                <div>
